...
function create() {
    ...
    MaxHpText = this.add.text(40, 102, 'Max Hp: 6', { fontSize: '16px', fill: '#0f0' });
    HPText = this.add.text(40, 114, 'Current Hp: 6', { fontSize: '16px', fill: '#0f0' });
    SoulText = this.add.text(40, 126, 'Soul Hearts: 0', { fontSize: '16px', fill: '#0f0' });
    SinText = this.add.text(40, 138, 'Hearts of Sin: 0', { fontSize: '16px', fill: '#0f0' });
    CoinText = this.add.text(40, 150, 'Coins: 0', { fontSize: '16px', fill: '#0f0' });
    BombText = this.add.text(40, 162, 'Bombs: 0', { fontSize: '16px', fill: '#0f0' });
    KeyText = this.add.text(40, 174, 'Keys: 0', { fontSize: '16px', fill: '#0f0' });
    ...
    DeadDove = this.physics.add.group();
    HolyGrail = this.physics.add.group();
    TheBody = this.physics.add.group();
    Robes = this.physics.add.group();
    Sbomb = this.physics.add.group();
    //-----------------------------------------------------------
    ...
    this.physics.add.collider(SoulHP, SinH);
    this.physics.add.collider(SinH, SinH);
    ...
    this.physics.add.overlap(player, SinH, powerupSin, null, this);
    ...
    this.physics.add.overlap(player, DeadDove, ADeadDove, null, this);
    this.physics.add.overlap(player, HolyGrail, TheHolyGrail, null, this);
    this.physics.add.overlap(player, TheBody, Body, null, this);
    this.physics.add.overlap(player, Robes, CeremonialRobes, null, this);
    this.physics.add.overlap(player, Sbomb, SadBomb, null, this);
    // ------------------------------------------------------------------------
        ...
        if (BombWait == false) {
            ...
            if (currentBombs >= 1) {
                ...
                setTimeout(function () {
                    ...
                    bombsE.setScale(3);
                    setTimeout(function () {
                        if (SadBombActive == true) {
                            bomb2z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            ...
                            bomb1z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            bomb1z.setCollideWorldBounds(true);
                            bomb1z.setVelocityY(Up);
                            ...
                            bomb3z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            bomb3z.setCollideWorldBounds(true);
                            bomb3z.setVelocityY(Down);
                            ...
                            bomb4z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            bomb4z.setCollideWorldBounds(true);
                            bomb4z.setVelocityX(Right);
                            ...
                            b4z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            b4z.setCollideWorldBounds(true);
                            b4z.setVelocityX(Right);
                            b4z.setVelocityY(Up);
                            b4z.body.onWorldBounds = true;
                            b4z.body.world.on('worldbounds', function (body) {
                                if (body.gameObject === this) {
                                    this.disableBody(true, true)
                                }
                            }, b4z);
                            b3z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            b3z.setCollideWorldBounds(true);
                            b3z.setVelocityX(Right);
                            b3z.setVelocityY(Down);
                            b3z.body.onWorldBounds = true;
                            b3z.body.world.on('worldbounds', function (body) {
                                if (body.gameObject === this) {
                                    this.disableBody(true, true)
                                }
                            }, b3z);
                            b2z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            b2z.setCollideWorldBounds(true);
                            b2z.setVelocityX(Left);
                            b2z.setVelocityY(Up);
                            b2z.body.onWorldBounds = true;
                            b2z.body.world.on('worldbounds', function (body) {
                                if (body.gameObject === this) {
                                    this.disableBody(true, true)
                                }
                            }, b2z);
                            b1z = bomb2s.create(bombsE.x, bombsE.y, 'bomb')
                            b1z.setCollideWorldBounds(true);
                            b1z.setVelocityX(Left);
                            b1z.setVelocityY(Down);
                            b1z.body.onWorldBounds = true;
                            b1z.body.world.on('worldbounds', function (body) {
                                if (body.gameObject === this) {
                                    this.disableBody(true, true)
                                }
                            }, b1z);
